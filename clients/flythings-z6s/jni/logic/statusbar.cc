...
static bool onButtonClick_ButtonStatusBarBack(ZKButton *pButton) {
	EASYUICONTEXT->goBack();
    LOGD(" ButtonClick ButtonStatusBarBack !!!\n");
    return false;
}

static bool onButtonClick_ButtonStatusBarHome(ZKButton *pButton) {
	EASYUICONTEXT->goHome();
    LOGD(" ButtonClick ButtonStatusBarHome !!!\n");
    return false;
}
