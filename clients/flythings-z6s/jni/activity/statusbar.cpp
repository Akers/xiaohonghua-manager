...
static ZKButton* mButtonStatusBarHomePtr;
static ZKButton* mButtonStatusBarBackPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_STATUSBAR_ButtonStatusBarHome, onButtonClick_ButtonStatusBarHome,
    ID_STATUSBAR_ButtonStatusBarBack, onButtonClick_ButtonStatusBarBack,
};
/***************/
...
statusbar::~statusbar() {
    ...
    mButtonStatusBarHomePtr = NULL;
    mButtonStatusBarBackPtr = NULL;
}
...
void statusbar::onCreate() {
    ...
    mButtonStatusBarHomePtr = (ZKButton*)findControlByID(ID_STATUSBAR_ButtonStatusBarHome);
    mButtonStatusBarBackPtr = (ZKButton*)findControlByID(ID_STATUSBAR_ButtonStatusBarBack);
	mstatusbarPtr = this;
	onUI_init();
    // 注册监听全局触摸
