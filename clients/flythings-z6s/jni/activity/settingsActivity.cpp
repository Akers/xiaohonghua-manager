...
static ZKListView* mListViewJiFenSettingPtr;
...
static S_ListViewFunctionsCallback SListViewFunctionsCallbackTab[] = {
    ID_SETTINGS_ListViewJiFenSetting, getListItemCount_ListViewJiFenSetting, obtainListItemData_ListViewJiFenSetting, onListItemClick_ListViewJiFenSetting,
};
...
void settingsActivity::onCreate() {
	Activity::onCreate();
    mListViewJiFenSettingPtr = (ZKListView*)findControlByID(ID_SETTINGS_ListViewJiFenSetting);if(mListViewJiFenSettingPtr!= NULL){mListViewJiFenSettingPtr->setListAdapter(this);mListViewJiFenSettingPtr->setItemClickListener(this);}
	mActivityPtr = this;
	onUI_init();
