...
static ZKButton* mButtonLuoboPtr;
static ZKButton* mButtonCloseWindowDuihuanPtr;
static ZKButton* mButtonTVPtr;
static ZKWindow* mWindowDuihuanPtr;
static ZKTextView* mTextView1Ptr;
static ZKTextView* mTextViewMainMessagePtr;
static ZKDigitalClock* mDigitalClockMainPtr;
static ZKTextView* mTextViewScoresPtr;
static ZKButton* mButtonSettingsPtr;
static ZKButton* mButtonCryPtr;
static ZKButton* mButtonHappyPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MAIN_ButtonLuobo, onButtonClick_ButtonLuobo,
    ID_MAIN_ButtonCloseWindowDuihuan, onButtonClick_ButtonCloseWindowDuihuan,
    ID_MAIN_ButtonTV, onButtonClick_ButtonTV,
    ID_MAIN_ButtonSettings, onButtonClick_ButtonSettings,
    ID_MAIN_ButtonCry, onButtonClick_ButtonCry,
    ID_MAIN_ButtonHappy, onButtonClick_ButtonHappy,
};
/***************/
...
mainActivity::~mainActivity() {
  ...
  // 退出应用时需要反注册
    ...
    onUI_quit();
    mActivityPtr = NULL;
    mButtonLuoboPtr = NULL;
    mButtonCloseWindowDuihuanPtr = NULL;
    mButtonTVPtr = NULL;
    mWindowDuihuanPtr = NULL;
    mTextView1Ptr = NULL;
    mTextViewMainMessagePtr = NULL;
    mDigitalClockMainPtr = NULL;
    mTextViewScoresPtr = NULL;
    mButtonSettingsPtr = NULL;
    mButtonCryPtr = NULL;
    mButtonHappyPtr = NULL;
}
...
void mainActivity::onCreate() {
	Activity::onCreate();
    mButtonLuoboPtr = (ZKButton*)findControlByID(ID_MAIN_ButtonLuobo);
    mButtonCloseWindowDuihuanPtr = (ZKButton*)findControlByID(ID_MAIN_ButtonCloseWindowDuihuan);
    mButtonTVPtr = (ZKButton*)findControlByID(ID_MAIN_ButtonTV);
    mWindowDuihuanPtr = (ZKWindow*)findControlByID(ID_MAIN_WindowDuihuan);
    mTextView1Ptr = (ZKTextView*)findControlByID(ID_MAIN_TextView1);
    mTextViewMainMessagePtr = (ZKTextView*)findControlByID(ID_MAIN_TextViewMainMessage);
    mDigitalClockMainPtr = (ZKDigitalClock*)findControlByID(ID_MAIN_DigitalClockMain);
    mTextViewScoresPtr = (ZKTextView*)findControlByID(ID_MAIN_TextViewScores);
    mButtonSettingsPtr = (ZKButton*)findControlByID(ID_MAIN_ButtonSettings);
    mButtonCryPtr = (ZKButton*)findControlByID(ID_MAIN_ButtonCry);
    mButtonHappyPtr = (ZKButton*)findControlByID(ID_MAIN_ButtonHappy);
	mActivityPtr = this;
	onUI_init();
